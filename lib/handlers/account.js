...
// define a single account handler object
const _account = {};
...
const accountRouteObj = {
    'account/get': _account.get,
    'account/create': _account.post,
    'account/edit': _account.put,
    'account/delete': _account.delete,
}
// export module
module.exports = accountRouteObj;